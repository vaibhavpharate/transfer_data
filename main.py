...
logging.basicConfig(filename=f"{directory_path}/logs/files.log",
...
# Get the logging csv
logger_path = f'{directory_path}/logs/transfer.csv'
...
db_connection = get_connection(host = data_configs['host'],
                              port = data_configs['port'],
                              user = data_configs['user'],
                              passord= data_configs['password'],
                              database= data_configs['database'])
